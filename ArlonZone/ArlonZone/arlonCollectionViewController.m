...
- (void)viewDidLoad {
    ...
    //注册cell
    [self.myCollection registerClass:[arlonCollectionCell class] forCellWithReuseIdentifier:CELL_INDI];
...
{
    arlonCollectionCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:CELL_INDI forIndexPath:indexPath];
